...
const BONUS: Bonus[] = [{ attribute: EnumAttribute.CONSTITUTION, value: 2 }];
const MAX_AGE = 350;
const HEIGHT: Height = { min: 90, max: 120 };
const DISPLACEMENT = 9;
const NAMES: Names[] = [
  {
    type: EnumTypeNames.MASC,
    examples: [
      'Adrik',
      'Alberich',
      'Baern',
